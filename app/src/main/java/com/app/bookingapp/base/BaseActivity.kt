package com.app.bookingapp.base
...
open class BaseActivity : AppCompatActivity(), ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    fun alertDialogCloseTryWithMsg(activity: Context,image:Int, textHeader:String, textMsg:String){
    ...
    fun noInternetConnection(baseActivity:BaseActivity, context: Context){
        Log.d(">>@D-NO INTERNET","=")
        baseActivity.alertDialogWithMsg(context!!,android.R.drawable.ic_dialog_info,
